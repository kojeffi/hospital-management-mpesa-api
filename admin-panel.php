...
<html lang="en">
  ...
  <a class="navbar-brand text-white" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i>Jamy Hospital </a>
...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link text-white" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a>
      </li>
       <li class="nav-item">
  ...
  <body style="padding-top:50px;">
   ...
   <h2 style="margin-left: 40%; padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;">
    Welcome&nbsp;<span class="text-info" id="username"><?php echo $username ?></span>
</h2>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <a href="about.php">
                      <input type="submit" value="Pay for Consultancy with M-pesa" class="btn btn-success" id="inputbtn">
                  ...
                  ?>
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                      echo "Cancelled by Doctor";
                        ...
                        <td><a href="about.php">
                        <button class="btn btn-success">Pay With M-pesa</button></a></td>
                      </tr>
                    <?php } ?>
                </tbody>
              </table>
